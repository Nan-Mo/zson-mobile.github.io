...
import { ConfigProvider, Cell, Button, SearchBar, Modal, Keyboard, Radio, Message } from 'zson-mobile';
import enUS from 'zson-mobile/lib/config-provider/locale/en_US';
...
| 属性         | 类型              | 默认值    | 说明                                                                                                                                |
| :----------- | :---------------- | :-------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| locale       | Object            | -         | 语言包配置，默认为中文，语言包可到 [zson-mobile/lib/config-provider/locale](https://unpkg.com/zson-mobile/lib/config-provider/locale/) 目录下寻找 |
