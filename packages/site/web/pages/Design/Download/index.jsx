...
const RESOURCES = [
  ...
  //   title: 'Zson Web',
  //   description: <FormattedMessage id="app.home.resources.type.zson-web" />,
  ...
  // },
  {
    ...
    title: 'Zson Web Frame',
    description: <FormattedMessage id="app.home.resources.type.zson-web-frame" />,
    url: 'https://nstatic.zhongan.com/hfe-static/zarm/resources/Zarm-Web-Frame.0.0.1.sketch',
  },
  {
    icon: require('./images/icon-axure.png'),
    title: 'Zson Library For Axure',
    description: <FormattedMessage id="app.home.resources.type.zson-axure" />,
    url: 'https://nstatic.zhongan.com/hfe-static/zarm/resources/Zarm-Mobile-Library.rplib',
  },
  {
    icon: require('./images/icon-axure.png'),
    title: 'Zson Web Library For Axure',
    description: <FormattedMessage id="app.home.resources.type.zson-web-axure" />,
